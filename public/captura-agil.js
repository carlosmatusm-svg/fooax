...
(function () {
  ...
  // 5) (RETIRADO 28-jul) Aquí vivía una pantalla de denominaciones POR CLIENTA
  //    que guardaba un `desglose` en cada pago. Ese desglose se sumaba encima
  //    del conteo del día y contaba los mismos billetes DOS VECES (a Karina le
  //    'sobraban' $140 que nunca le sobraron). Regla de Karina: en toda la app
  //    hay UN SOLO arqueo — el de la pestaña Arqueo. En el mixto se escribe el
  //    monto en efectivo y ya; los billetes se cuentan una vez, al final del día.
